...
module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      xxs: ['0.12rem', { lineHeight: '0.15rem' }],
      xs: ['0.16rem', { lineHeight: '0.2rem' }],
      sm: ['0.24rem', { lineHeight: '0.3rem' }],
      base: ['0.36rem', { lineHeight: '0.4rem' }],
      lg: ['0.48rem', { lineHeight: '0.52rem' }],
      xl: ['0.75rem', { lineHeight: '1rem' }],
      '2xl': ['0.875rem', { lineHeight: '1.25rem' }],
      '3xl': ['1rem', { lineHeight: '1.5rem' }],
      '4xl': ['1.125rem', { lineHeight: '1.75rem' }],
      '5xl': ['1.25rem', { lineHeight: '1.75rem' }],
      '6xl': ['1.5rem', { lineHeight: '2rem' }],
      '7xl': ['1.875rem', { lineHeight: '2.25rem' }],
